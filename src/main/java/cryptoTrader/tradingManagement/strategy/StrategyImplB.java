...
class StrategyImplB implements Strategy {
    ...
    // singleton
    private static StrategyImplB instance;
    ...
    // the correct length of coins that should be passed
     ...
     * a
     * new object of StrategyImplB.
     * 
     * @return the instance of StrategyImplB
     */
    public static StrategyImplB getInstance() {
        if (instance == null)
            instance = new StrategyImplB();
        return instance;
    }
     ...
     */
    private StrategyImplB() {

        // initialize strategy name
        strategyName = "Strategy-B";

        // initialize strategy condition
        conditionString = "If the price of coin1 is greater than $3,000 " +
                "then sell 100 coin1 coins";
        ...
        // limit of condition for coin1
        coin1PriceLimit = 3000;

        // size the list of coins must be
        coinListSize = 1;

        // example of how the user should use this strategy
        example = "eth";
    }
