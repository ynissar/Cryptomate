 ...
 */
// Singleton
class StrategyImplD implements Strategy {

    // singleton
    private static StrategyImplD instance;
     ...
     * a
     * new object of StrategyImplD.
     * 
     * @return the instance of StrategyImplD
     */
    public static StrategyImplD getInstance() {
        if (instance == null)
            instance = new StrategyImplD();
        return instance;
    }
     ...
     */
    private StrategyImplD() {

        // initialize strategy name
        strategyName = "Strategy-D";

        // initialize strategy condition
        conditionString = "If the price of coin1 is less than $2000 " +
                "then sell 50 coin1 coins";
